        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "to_civ": {
                        "type": "string",
                        "description": "Target civilization",
                        "enum": "{civ_names}",
                    },
                    "demand_luxury": {
                        "type": "string",
                        "description": "Luxuries needed",
                        "enum": "{luxury_space_list}",
                    },
                    "offer_gold_per_turn": {
                        "type": "integer",
                        "description": "The amount of gold to pay per turn",
                        "default": 10,
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "relation": {
                        "type": "string",
                        "description": "Current relation location",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "to_civ": {
                        "type": "string",
                        "description": "The Civilization of Invitation",
                        "enum": "{civ_names}",
                    },
                    "enemy_civ": {
                        "type": "string",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "offer_gold": {
                        "type": "integer",
                        "description": "The number of gold coins offered",
                        "default": 100,
                    },
                },

DeclareWarPrompt_Chat = """You need to analyze the latest conversation between you and output the results in the given format.
...
3. In the conversation above, he declared war on you, the result of your decision is {decision_result}, and the reason for your decision is {decision_reason}

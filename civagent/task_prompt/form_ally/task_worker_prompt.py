FormAllyPrompt_Chat = """You need to analyze the latest conversation between you and output the results in the given format.
...
3. In the conversation above, he asked you to be an ally, your decision result is {decision_result}, and your decision reason is {decision_reason}

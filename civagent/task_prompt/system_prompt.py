...
The country you are currently engaging with is {speaker_persona[civ_name]}. Your relationship with them is {relation[closeness]}, and in terms of geography, you are {relation[proximity]} in distance. Your current diplomatic status is {relation[diplomatic_status]}. Your level of technological advancement compared to {speaker_persona[civ_name]} is {relation[tech_strength_compare]}, your cultural influence compared to {speaker_persona[civ_name]} is {relation[culture_strength_compare]}, your military strength compared to {speaker_persona[civ_name]} is {relation[army_strength_compare]}, and your overall national power compared to {speaker_persona[civ_name]} is {relation[civ_strength_compare]}.
...
"""
DialogeHistoryPrompt = """{speaker_civ}: "{content}"。\n"""

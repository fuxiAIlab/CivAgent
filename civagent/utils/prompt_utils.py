...
def task_prompt_make(prompt_str: str, context_dict: Dict[str, Any]) -> str:
    return str_make(prompt_str, context_dict)


def dialogue_history_make(prompt_str: str, context_dict: Dict[str, Any]) -> str:
...
def event_history_make(prompt_str: str, context_dict: Dict[str, Any]) -> str:
...
def admin_reply_make(intention: str, context_dict: Dict[str, Any]) -> str:
    ...
    if "chinese" in context_dict.get("language", default_language).lower():
        from civagent.task_prompt_chinese.admin_reply.task_worker_prompt import (
            ADMIN_REPLY,
        )
    else:
...
def prompt_make(intention: str, context_dict: Dict[str, Any]) -> Tuple[str, Any]:
    if "chinese" in context_dict.get("language", "english").lower():
        import civagent.task_prompt_chinese as task_prompt
    ...
    prompt_config: dict[str, Any] = task_prompt.ProposeTradePrompt_Chat_Config
    if intention == "ask_for_object":
        ...
        context_dict = {
            **context_dict,
            **task_prompt.AskForObjectPrompt_Identify_Config,
        }
    ...
    #     prompt_config = task_prompt.DeclareWarPrompt_Chat_Config
        ...
        context_dict = {
            **context_dict,
            **task_prompt.FriendlyStatementPrompt_Chat_Config,
        }
        ...
        context_dict = {
            **context_dict,
            **task_prompt.IntentionUnderstandingPrompt_Config,
        }
        ...
        context_dict = {
            **context_dict,
            **task_prompt.ProposeTradePrompt_Identify_Config,
        }
        ...
        context_dict = {
            **context_dict,
            **task_prompt.ProposeTradePrompt_BarginBuyer_Config,
        }
        ...
        context_dict = {
            **context_dict,
            **task_prompt.ProposeTradePrompt_BarginSeller_Config,
        }
        ...
        context_dict = {
            **context_dict,
            **task_prompt.ResearchAgreementPrompt_Chat_Config,
        }

...
decision_reason_space = {
    ...
    "form_ally_no": [
        "He is not my best choice for an ally",
        "He is too weak",
        "He is not strong enough",
        "I am too far away from him",
    ],
    ...
    "open_border_yes": [
        "He has also opened borders to me",
        "I feel his goodwill",
        "We are too far away from each other, no threat to each other",
        "I know he just needs to pass through",
    ],
    "open_border_no": [
    ...
    "research_agreement_no": [
        "I feel threatened by him, I do not want to help him",
        "Our relationship is not so good",
    ],
    "seek_peace_yes": [
    ...
    "seek_peace_no": [
        ...
        "I am only temporarily at a disadvantage",
...
decision_space = {
    ...
    "ask_for_object": {
        ...
        "func": lambda decision: (
            gm_command.gm_command_space["ask_for_object"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    # Flattery
    "change_closeness": {
        "decisions": {
            "yes": "Increase diplomatic relations",
            "no": "Do not change diplomatic level",
        },
    ...
    "form_ally": {
        "decisions": {
            "yes": "Agree to form an alliance",
            "no": "Disagree to form an alliance",
        },
        "param": gm_command.gm_command_space["form_ally"]["param"],
        "func": lambda decision: (
            gm_command.gm_command_space["form_ally"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    # Friendly statement
    "friendly_statement": {
        "decisions": {
            "yes": "Agree to make a friendly statement",
            "no": "Disagree to make a friendly statement",
        },
        "param": gm_command.gm_command_space["friendly_statement"]["param"],
        "func": lambda decision: (
            gm_command.gm_command_space["friendly_statement"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    # Mutual defense
    "mutual_defense": {
        "decisions": {
            "yes": "Agree to a mutual defense pact",
            "no": "Disagree to a mutual defense pact",
        },
        "param": gm_command.gm_command_space["form_mutual_defense"]["param"],
        "func": lambda decision: (
            gm_command.gm_command_space["form_mutual_defense"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    # Open borders
    "open_border": {
        ...
        "func": lambda decision: (
            gm_command.gm_command_space["open_borders"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    ...
    "propose_trade": {
        ...
        "func": lambda decision: (
            gm_command.gm_command_space["propose_trade"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    # Common trade
    "propose_common_trade": {
        ...
        "func": lambda decision: (
            gm_command.gm_command_space["propose_common_trade"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    ...
    "seek_peace": {
        "decisions": {
            "yes": "Agree to a peace treaty",
            "no": "Disagree to a peace treaty",
        },
        "param": gm_command.gm_command_space["seek_peace"]["param"],
        "func": lambda decision: (
            gm_command.gm_command_space["seek_peace"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    # Persuade to deal with a common enemy
    "common_enemy": {
        "decisions": {
            "yes": "Agree with the notion of a common enemy",
            "no": "Disagree with the notion of a common enemy",
        },
        # todo change param
        "param": gm_command.gm_command_space["declare_war"]["param"],
        "func": lambda decision: (
            gm_command.gm_command_space["declare_war"]["func"] if decision == "yes" else identity_partial_fn
        ),
    },
    "declare_war": {
        # todo
    ...
    "cheat": {
        "decisions": {
            "yes": "Agree that the information is true",
            "no": "Disagree that the information is true",
        },
        "param": [],
        "func": lambda decision: identity_partial_fn,
    },
...
decision_reason_simulate_space = {
    ...
    "ask_for_object_no": {
        "reason": [
            "ask_for_object_no_too_many_cities_to_trade",
            "ask_for_object_no_value_diminishes",
            "ask_for_object_no_unforgivable_relationship",
            "ask_for_object_no_defense_treaty_not_close",
            "ask_for_object_no_value_greatly_diminished",
            "ask_for_object_no_hostile_relationship",
    ...
    "change_closeness_down": {
        "reason": [
            "friendly_statement_no_disadvantage",
            "friendly_statement_no_worse",
            "friendly_statement_no_made_too_many_friends",
            "friendly_statement_no_too_many_friendly_forces",
    ...
    "form_ally_no": {
        "reason": [
            "mutual_defense_no_no_good_relationship",
            "mutual_defense_no_not_get_along_with_my_friends",
            "mutual_defense_no_not_as_good_as_me",
            "mutual_defense_no_defensive_pact_drawn_into_battles",
            "mutual_defense_no_signed_enough",
            "mutual_defense_no_worse",
        ],
        "param": ["civ_name_1", "civ_name_2"],
        "func": lambda civ_name_1, civ_name_2: partial(
            simulator.run_wantsToSignDefensivePact,
    ...
    "open_border_yes": {
        "reason": [
            "open_border_yes_good_relationship",
            "open_border_yes_not_at_war_with_my_friends",
    ...
    "open_border_no": {
        "reason": [
            "open_border_no_no_good_relationship",
            "open_border_no_not_accept_war_with_friends",
    ...
    "research_agreement_yes": {
        "reason": [
            "research_agreement_yes_can_initiate_research_agreements",
    ...
    "research_agreement_no": {
        "reason": [
            "research_agreement_no_not_major_city",
            "research_agreement_no_didnt_study_properties",
            "research_agreement_no_nothing_to_study",
            "research_agreement_no_partner_not_major_city",
            "research_agreement_no_partner_didnt_study_properties",
            "research_agreement_no_partner_nothing_to_study",
            "research_agreement_no_cant_afford_to_pay",
    ...
    "seek_peace_yes": {
        "reason": [
            "motivation_to_attack_no_too_far",
            "motivation_to_attack_no_much_better_than_us",
            "motivation_to_attack_no_sacrifice_heavy",
            "motivation_to_attack_no_far_away_cities",
            "motivation_to_attack_no_signed_research_agreement",
            "motivation_to_attack_no_declared_friendship",
            "motivation_to_attack_no_allies",
            "motivation_to_attack_no_do_business",
            "motivation_to_attack_no_just_city_states",
            "motivation_to_attack_no_confederate_city",
        ],
        "param": ["civ_name_1", "civ_name_2"],
        "func": lambda civ_name_1, civ_name_2: partial(
    ...
    "seek_peace_no": {
        "reason": [
            "motivation_to_attack_yes_military_force_overwhelmed_opposite_side",
            "motivation_to_attack_yes_far_more_military_power",
            "motivation_to_attack_yes_more_military_power",
            "motivation_to_attack_yes_military_strength_slightly_stronger",
            "motivation_to_attack_yes_relationship_unforgivable",
            "motivation_to_attack_yes_hostile_relationship",
            "motivation_to_attack_yes_they_were_alone",
            "motivation_to_attack_yes_cant_let_other_side_win",
            "motivation_to_attack_yes_no_way_to_get_there",
        ],
        "param": ["civ_name_1", "civ_name_2"],
        "func": lambda civ_name_1, civ_name_2: partial(
            simulator.run_hasAtLeastMotivationToAttack,

...
mq: RedisStreamMQ = RedisStreamMQ()


def gm_router(user_input: str, save_data: Dict[str, Any]) -> Tuple[Dict[str, Any], str]:
    ...
    if "gold" in user_input:
        ...
        return (
            utils.declare_war(save_data, civ_name_1, civ_name_2),
            "declare_war success",
        )
        ...
        civ_name_2 = input_parts[2] if len(input_parts) >= 3 else ""
        return (
            utils.open_borders(save_data, civ_name_1, civ_name_2),
        ...
        civ_name_2 = input_parts[2] if len(input_parts) >= 3 else ""
        return (
            utils.research_agreement(save_data, civ_name_1, civ_name_2),
            "research_agreement success",
        )
        ...
        civ_name_2 = input_parts[2] if len(input_parts) >= 3 else ""
        return (
            utils.form_mutual_defense(save_data, civ_name_1, civ_name_2),
            "mutual_defense success",
        )
        ...
        return (
            utils.annex_city(save_data, civ_name_1, civ_name_2, city_name),
            "annex_city success",
        )
    else:
...
def gm_commander(gm_text: str, save_data: Dict[str, Any]) -> Tuple[Dict[str, Any], str]:
    try:
        save_data, msg = gm_router(gm_text, save_data)
        # print(msg, text)
